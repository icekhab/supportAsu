...
import 'package:angular/src/facade/lang.template.dart' as _ref8;
import 'package:angular/src/platform/dom/events/event_manager.template.dart' as _ref9;
...
void initReflector() {
  ...
  _ngRef.registerDependencies(
    ...
    const [
      const [
        const _ngRef.Inject(const _ngRef.OpaqueToken(r'AppId')),
      ],
      const [
        SanitizationService,
      ],
